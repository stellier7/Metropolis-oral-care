...
(function () {
  ...
  function buildMapsUrls(addr, fullAddress) {
    ...
    const mapLang = document.documentElement.lang === "en" ? "en" : "es";
    ...
    if (coords && Number.isFinite(coords.lat) && Number.isFinite(coords.lng)) {
      ...
      return {
        embed: `https://maps.google.com/maps?q=${encodeURIComponent(destination)}&hl=${mapLang}&z=${zoom}&ie=UTF8&iwloc=&output=embed`,
        link: addr.mapsLink || buildMapsDirectionsLink(addr, fullAddress, coords),
      };
    }
    ...
    return {
      embed: `https://maps.google.com/maps?q=${encoded}&hl=${mapLang}&z=${zoom}&ie=UTF8&iwloc=&output=embed`,
